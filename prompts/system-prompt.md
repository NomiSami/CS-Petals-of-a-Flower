...
## Rules for Output — Revised per User Notes gist 4b2d8789
- Output in markdown with ## Chapter Title
- Epigraph (found text sign/note/log/song) is good but optional — ensure chapters with strong enough starts or continuing immediately from active scene won't need them
- Use *italics* for internal thoughts
- Keep chapters 3000-5000 words, but 1 chapter per installment now (focus revisions)
- Avoid exact canon lines — context completely changed, write new matching voice
- Include planning doc first installment: Shape, Canon Anchors, Divergences, World Bible condensed, Voice & Style, Held in Reserve, Contents — but now diverge more from original, allow opportunistic changes
- Model can make up unverifiable high-potential info/character interpretations for mysticism
- Keep title and contents coherent
- Mysteries can change if writing opportunities arise
